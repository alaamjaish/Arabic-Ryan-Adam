...
const ALL_VERBS: Verb[] = [
  ...
  { id: 'spend-the-night', english: 'I spend the night', arPresent: 'أبيت', phPresent: 'Abeet', family: 1, pastAna: { ar: 'بت', ph: 'Bitt' }, pastHuwa: { ar: 'بات', ph: 'Baat' }, draft: true },
  ...
  { id: 'hide', english: 'I hide', arPresent: 'أخبّي', phPresent: 'Akhabbi', family: 2, pastAna: { ar: 'خبّيت', ph: 'Khabbait' }, pastHuwa: { ar: 'خبّى', ph: 'Khabba' }, draft: true },
  ...
  { id: 'invite', english: 'I invite', arPresent: 'أعزم', phPresent: 'A3zom', family: 5, pastAna: { ar: 'عزمت', ph: '3azamt' }, pastHuwa: { ar: 'عزم', ph: '3azam' }, draft: true },
  { id: 'fry', english: 'I fry', arPresent: 'أقلي', phPresent: 'Aqli', family: 2, pastAna: { ar: 'قليت', ph: 'Qalait' }, pastHuwa: { ar: 'قلى', ph: 'Qala' }, draft: true },
  { id: 'crave', english: 'I crave', arPresent: 'أشتهي', phPresent: 'Ashtahi', family: 2, pastAna: { ar: 'اشتهيت', ph: 'Ashtahait' }, pastHuwa: { ar: 'اشتهى', ph: 'Ashtaha' }, draft: true },
  ...
  { id: 'bite', english: 'I bite', arPresent: 'أعضّ', phPresent: 'A3udd', family: 3, pastAna: { ar: 'عضّيت', ph: '3addait' }, pastHuwa: { ar: 'عضّ', ph: '3add' }, draft: true },
  ...
  { id: 'watch', english: 'I watch', arPresent: 'أشاهد', phPresent: 'Ashahed', family: 1, pastAna: { ar: 'شاهدت', ph: 'Shahadt' }, pastHuwa: { ar: 'شاهد', ph: 'Shahad' } },
  ...
  { id: 'fall', english: 'I fall', arPresent: 'أوقع', phPresent: 'Awqa3', family: 5, pastAna: { ar: 'وقعت', ph: 'Wqi3t' }, pastHuwa: { ar: 'وقع', ph: 'Wiqi3' }, draft: true },
  { id: 'arrive', english: 'I arrive', arPresent: 'أوصل', phPresent: 'Awsal', family: 5, pastAna: { ar: 'وصلت', ph: 'Wsilt' }, pastHuwa: { ar: 'وصل', ph: 'Wisil' }, draft: true },
  { id: 'send', english: 'I send', arPresent: 'أبعت', phPresent: 'Ab3at', family: 5, pastAna: { ar: 'بعت', ph: 'Ba3att' }, pastHuwa: { ar: 'بعت', ph: 'Ba3at' }, draft: true },
  ...
  { id: 'make', english: 'I make / do', arPresent: 'أعمل', phPresent: 'A3mel', family: 5, pastAna: { ar: 'عملت', ph: '3milt' }, pastHuwa: { ar: 'عمل', ph: '3imil' }, draft: true },
  ...
  { id: 'add', english: 'I add', arPresent: 'أضيف', phPresent: 'Adeef', family: 1, pastAna: { ar: 'ضفت', ph: 'Dift' }, pastHuwa: { ar: 'ضاف', ph: 'Daaf' }, draft: true },
  ...
  // Family 2
  { id: 'hope', english: 'I hope', arPresent: 'أتمنى', phPresent: 'Atmanna', family: 2, pastAna: { ar: 'تمنيت', ph: 'Tmannait' }, pastHuwa: { ar: 'تمنى', ph: 'Tmanna' }, draft: true },
  ...
  { id: 'rent', english: 'I rent', arPresent: 'أستأجر', phPresent: "Asta'jer", family: 5, pastAna: { ar: 'استأجرت', ph: "Esta'jart" }, pastHuwa: { ar: 'استأجر', ph: "Esta'jar" }, draft: true },
  ...
  // Family 3
  { id: 'guide', english: 'I guide / show the way', arPresent: 'أدلّ', phPresent: 'Adill', family: 3, pastAna: { ar: 'دلّيت', ph: 'Dallait' }, pastHuwa: { ar: 'دلّ', ph: 'Dall' }, draft: true },
  ...
  { id: 'spray', english: 'I spray / sprinkle', arPresent: 'أرشّ', phPresent: 'Arushsh', family: 3, pastAna: { ar: 'رشّيت', ph: 'Rashshait' }, pastHuwa: { ar: 'رشّ', ph: 'Rashsh' }, draft: true },
  ...
  { id: 'wrap', english: 'I wrap', arPresent: 'ألفّ', phPresent: 'Aluff', family: 3, pastAna: { ar: 'لفّيت', ph: 'Laffait' }, pastHuwa: { ar: 'لفّ', ph: 'Laff' }, draft: true },
  // Family 4
  { id: 'raise', english: 'I raise / bring up', arPresent: 'أربّي', phPresent: 'Arabbi', family: 2, pastAna: { ar: 'ربّيت', ph: 'Rabbait' }, pastHuwa: { ar: 'ربّى', ph: 'Rabba' }, draft: true },
  { id: 'cover', english: 'I cover', arPresent: 'أغطّي', phPresent: 'Aghatti', family: 2, pastAna: { ar: 'غطّيت', ph: 'Ghattait' }, pastHuwa: { ar: 'غطّى', ph: 'Ghatta' }, draft: true },
  { id: 'fill', english: 'I fill', arPresent: 'أعبّي', phPresent: 'A3abbi', family: 2, pastAna: { ar: 'عبّيت', ph: '3abbait' }, pastHuwa: { ar: 'عبّى', ph: '3abba' }, draft: true },
  ...
  { id: 'recommend-order', english: 'I recommend / order (food)', arPresent: 'أوصّي', phPresent: 'Awassi', family: 2, pastAna: { ar: 'وصّيت', ph: 'Wassait' }, pastHuwa: { ar: 'وصّى', ph: 'Wassa' }, draft: true },
  ...
  { id: 'peel', english: 'I peel', arPresent: 'أقشّر', phPresent: 'Aqashsher', family: 4, pastAna: { ar: 'قشّرت', ph: 'Qashshart' }, pastHuwa: { ar: 'قشّر', ph: 'Qashshar' }, draft: true },
